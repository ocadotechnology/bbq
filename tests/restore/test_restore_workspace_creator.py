...
class TestRestoreWorkspaceCreator(TestCase):
    ...
    # def test_should_create_table_if_is_partitioned_and_not_exist(self, _, _1):
    #     # given
    #     enforcer = RestoreWorkspaceCreator(self.BQ)
    #     source, target = self.__create_partitioned_table_references()
    #
    ...
    # def test_should_not_create_table_if_is_not_partitioned(self, _):
    #     # given
    #     enforcer = RestoreWorkspaceCreator(self.BQ)
    ...
    #
    #     # then
    #     BigQueryTableMetadata.get_table_by_reference_cached.assert_not_called()
